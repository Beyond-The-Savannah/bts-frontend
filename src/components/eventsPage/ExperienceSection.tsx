      ...
      {/* <section className=" ">
        <div className="container mx-auto min-h-[80dvh] grid py-20 gap-4  px-4">
          ...
          <div className="flex flex-wrap md:flex-nowrap justify-center gap-12 my-10">
            <div className="w-full md:w-4/12 border-2 rounded-xl px-4 py-8 space-y-8 bg-linear-to-tr from-bts-BrownTwo via-bts-GreenOne/20 to-bts-GreenOne/5">
      ...
      <section className="bg-[#f9f7f2]">
        ...
        <div className="container mx-auto  py-20 gap-4  px-4">
          ...
          <div className="flex flex-wrap  justify-center gap-4 my-10">
            <div className="w-full lg:w-10/12 border-2 rounded-xl px-4 py-8 space-y-8 bg-linear-to-tr from-bts-BrownTwo via-bts-GreenOne/20 to-bts-GreenOne/5">
              <p className="text-center text-xl font-semibold">
                Premier Global recruiters
              </p>
