...
export default async function HeroSection() {
  ...
  return (
    <>
      <section className="container mx-auto mt-5 md:mt-10 lg:pt-10 lg:mb-20 px-2 md:px-4 xs:min-h-[99dvh] md:min-h-[90dvh] lg:min-h-[90dvh] xl:min-h-[90dvh] 2xl:min-h-[90dvh] flex flex-col justify-center">
        <div className=" text-balance space-y-4  max-w-7xl mx-auto">
          ...
          <p className="text-base md:text-lg lg:text-lg w-12/12  lg:w-[60dvw] 2xl:w-[55dvw] text-center mx-auto">
            ...
            the right remote talent. <br/>We source, vet, and match skilled global
