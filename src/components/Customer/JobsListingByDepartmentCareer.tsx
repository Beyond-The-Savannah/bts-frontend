      ...
      <Suspense>
        {jobSubCategoryId == undefined ? (
          <div className="bg-yellow-100 rounded-lg px-4 py-8 my-20 w-full flex gap-3">
            <CircleAlert />
            <p>
              Please head over to the &ldquo;Career Selection&ldquo; and select
              your career category in order to view a job
            </p>
          </div>
        ) : (
          <section className="container mx-auto min-h-screen px-4">
            ...
            <div className="flex flex-wrap lg:justify-center  mb-20 gap-8 md:gap-2 md:gap-y-8 lg:gap-8 py-10">
              {paginatedRemoteJobs?.map((job, index) => (
                <div
                  key={index}
                  className=" border-bts-BrownTwo/50 border-2 rounded-xl w-full md:w-88 lg:w-10/12 bg-bts-BrownTwo/50 hover:shadow-bts-BrownFour hover:shadow-md hover:bg-bts-BrownFive/50 duration-700 px-8 py-4"
                >
