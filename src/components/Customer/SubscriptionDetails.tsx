        ...
        <div className="w-full mx-auto px-4">
          ...
          <div className="min-h-[70vh] mt-10 md:mt-20">
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-between gap-8">
              ...
              {jobsListingSubscriptionDetails !=undefined ? (
                <div className="flex flex-wrap justify-between space-y-4 rounded-lg bg-bts-BrownOne/50 px-6 py-12 w-full flex-1 ">
                  ...
                  <p className="font-semibold text-xl">Jobs Listings Subscription details</p>
                  ...
                  <p className="flex flex-col">
                    ...
                    <span className="font-semibold ml-1">
                      XXXX XXXX {jobsListingSubscriptionDetails?.authorization.last4}
                    </span>
                  </p>
                  ...
                  <div className="">
                    <form action={handleManageSubscription}>
                      <input type="hidden" name="subscriptionCode" value={jobsListingSubscriptionDetails?.subscription_code} />
              ...
              {whatsAppSubscriptionDetails!=undefined ? (
                <div className="flex flex-wrap justify-between space-y-4 rounded-lg bg-bts-BrownOne/50 px-6 py-12 w-full flex-1">
                  <div className="space-y-4">
                    <p className="font-semibold text-xl">Whatsapp Subscription details</p>
                    <p className="flex  flex-col">
                      <span className="text-xs">Subscription Email Address: </span>
                      <span className="text-sm lg:text-base font-semibold ml-1">
                    ...
                    <p className="flex flex-col">
                      <span className="text-xs">Subscription Card Number: </span>
                      <span className="font-semibold ml-1">
                        XXXX XXXX {whatsAppSubscriptionDetails?.authorization.last4}
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="">
                    <form action={handleManageSubscription}>
                      <input type="hidden" name="subscriptionCode" value={whatsAppSubscriptionDetails?.subscription_code}/>
                      <Button variant="outline" size="sm" type="submit">
            ...
            {jobsListingSubscriptionDetails?.plan.amount !== 600000 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
              <CareerSelection  emailAddress={jobsListingSubscriptionDetails?.customer.email as string}/>
              <ResumeUpload/>
