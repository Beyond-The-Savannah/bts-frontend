        ...
        <div className="py-10">
         ...
         <div className="grid grid-cols-1 md:grid-cols-12 items-center justify-center space-y-8 pb-20 pt-0 md:pt-20">
          <div className="col-span-12 md:col-start-2  md:col-end-12 lg:col-end-8 space-y-4">
            <p className="text-lg">
              Whether you&apos;re a company looking for talent, an educator ready to empower learners, or a changemaker with a vision we want to hear from you.
            </p>
            <p className="text-lg">
              The future of work is remote, global, and diverse. Beyond the Savannah is at the forefront of this transformation, and we&apos;re looking for partners who want to shape this future with us.
            </p>
          </div>
