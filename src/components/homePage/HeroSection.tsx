...
export default function HeroSection() {
  return (
    <>
      ...
      <section className="container mx-auto px-4 xs:min-h-[99dvh] md:min-h-[90dvh] lg:min-h-[90dvh] xl:min-h-[90dvh] 2xl:min-h-[90dvh]    grid grid-cols-1 md:grid-cols-2  md:pt-0  gap-4">
